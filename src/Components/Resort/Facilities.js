			...
			<Container>
				<Row className="h">
					<div className="col-md-12">
						...
						<p className="bird-subtitle1" style={{marginTop:'30px'}} id="r1">Restaurant and Bars</p>
							<img
							...
							<p>
								...
								>
									...
									Colombo Gem Crafts and Sangems & Jewellery<a href='http://www.sangems.com/' style={{textDecoration:'underline'}} className="home-linkay"> www.sangems.com</a> 
								</p>
							</p>
							...
							<a href="/ayurweda" style={{textDecoration:'underline'}} className="home-link2">
								<p className='fas-link'>More Ayurveda & Yoga</p>
							</a>
