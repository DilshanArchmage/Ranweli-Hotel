					...
					<div className="col-md-8">
						<div className="uper-body">
							...
							<div className="welcome-body">
								...
								<div className="col-md-12">
									<p className="activity-body">
										Mr. Mehta is a Senior Director of The International
										Ecotourism Society (TIES) Washington D.C, and adjunct
										Professor at Florida International University. He is also
										one of the leading professionals in the field of planning
										and designing of eco lodges, has written several research
										papers on the subject and speaks regularly at conferences
										around the world. His web site on eco lodges is{" "}
										<a href="" className="home-linkac">
											www.eco-mon.com
										</a>{" "}
