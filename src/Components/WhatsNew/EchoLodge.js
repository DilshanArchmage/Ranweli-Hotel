							...
							<Row>
								...
								<div className="col-md-8">
									<p className="activity-body" style={{ paddingLeft: "20px" }}>
										...
										will be among 35 around the world and the only one from Sri
										Lanka to be included in this publication by Harper Collins.
									</p>
								</div>
							</Row>
							<div className="col-md-12">
								<p
									className="echoactivity-body"
									style={{ marginLeft: "-10px" }}
								>
									The picture shows left to right Messrs. Chandra de Silva
									former CEO, Hitesh Mehta and R. S. Wijewardene- Chairman. Mr.
									Mehta is a landscape architect, environmental planner and
									worked at Edward D. Stone Jr. and Associates, Florida which is
									one of the leading Ecotourism planning and landscape
									architectural firms in the world.
								</p>
							</div>
							<div className="col-md-12">
								<p className="eactivity-body" style={{ marginLeft: "-10px" }}>
									Mr. Mehta has been consulted on the design of several eco
									lodges in Eastern Africa including the famous Lobolo Lodge on
									the western shores of Lake Turkana. Other consultancies inter
									alia include eco lodges in Guyana, West Indies, Panama, Egypt,
									Kerala and Florida. He has also worked with the European Union
									on the diversification of tourism in Kenya and with USAID on
									the development of eco lodge guidelines for the Red sea.
								</p>
							</div>
							<div className="col-md-12">
								<p className="activity-body" style={{ marginLeft: "-10px" }}>
									...
									His web site on eco lodges is{" "}
									<a href="" className="home-link2">
										www.eco-mon.com
									</a>{" "}
									the only one of its kind on the Internet.
								</p>
							</div>
